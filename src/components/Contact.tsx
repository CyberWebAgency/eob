            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@eastocyonbio.com" className="text-gray-600 hover:text-primary-600 transition-colors">
                      info@eastocyonbio.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 hover:bg-primary-100 transition-colors duration-300 p-2 rounded-full">
