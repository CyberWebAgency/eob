...
<script>
  tinymce.init({
    ...
    toolbar: 'undo redo | blocks | bold italic | alignleft aligncenter alignright | bullist numlist outdent indent | link image | table | code | help',
    height: 400,
    promotion: false,
    branding: false,
    menubar: true,
    ...
    ai_ask: false,
    ai_show_help: false,
    ai_show_help_modal: false,
    ai_show_help_toolbar: false,
    ai_show_help_statusbar: false,
    ai_show_help_menu: false,
    ai_show_help_sidebar: false,
    ai_show_help_dialog: false,
    ai_show_help_notification: false,
    ai_show_help_tooltip: false,
    ai_show_help_popup: false,
    ai_show_help_bubble: false,
    ai_show_help_hint: false,
    ai_show_help_guide: false,
    ai_show_help_tour: false,
    ai_show_help_walkthrough: false,
    ai_show_help_tutorial: false,
    ai_show_help_demo: false,
    ai_show_help_example: false,
    ai_show_help_sample: false,
    ai_show_help_template: false,
    ai_show_help_pattern: false,
    ai_show_help_boilerplate: false,
    ai_show_help_snippet: false,
    ai_show_help_code: false,
    ai_show_help_markup: false,
    ai_show_help_html: false,
    ai_show_help_css: false,
    ai_show_help_js: false,
    ai_show_help_ts: false,
    ai_show_help_php: false,
    ai_show_help_python: false,
    ai_show_help_java: false,
    ai_show_help_csharp: false,
    ai_show_help_ruby: false,
    ai_show_help_go: false,
    ai_show_help_rust: false,
    ai_show_help_swift: false,
    ai_show_help_kotlin: false,
    ai_show_help_scala: false,
    ai_show_help_clojure: false,
    ai_show_help_haskell: false,
    ai_show_help_erlang: false,
    ai_show_help_elixir: false,
    ai_show_help_ocaml: false,
    ai_show_help_fsharp: false,
    ai_show_help_r: false,
    ai_show_help_matlab: false,
    ai_show_help_julia: false,
    ai_show_help_perl: false,
    ai_show_help_bash: false,
    ai_show_help_powershell: false,
    ai_show_help_batch: false,
    ai_show_help_shell: false,
    ai_show_help_sql: false,
    ai_show_help_mysql: false,
    ai_show_help_postgresql: false,
    ai_show_help_oracle: false,
    ai_show_help_mssql: false,
    ai_show_help_sqlite: false,
    ai_show_help_mongodb: false,
    ai_show_help_redis: false,
    ai_show_help_cassandra: false,
    ai_show_help_couchdb: false,
    ai_show_help_neo4j: false,
    ai_show_help_elasticsearch: false,
    ai_show_help_solr: false,
    ai_show_help_sphinx: false,
    ai_show_help_meilisearch: false,
    ai_show_help_typesense: false,
    ai_show_help_algolia: false,
    ai_show_help_airtable: false,
    ai_show_help_notion: false,
    ai_show_help_confluence: false,
    ai_show_help_jira: false,
    ai_show_help_trello: false,
    ai_show_help_asana: false,
    ai_show_help_clickup: false,
    ai_show_help_monday: false,
    ai_show_help_wrike: false,
    ai_show_help_smartsheet: false,
    ai_show_help_airtable: false,
    ai_show_help_notion: false,
    ai_show_help_confluence: false,
    ai_show_help_jira: false,
